...
class DIDChat {
  constructor(containerId) {
    ...
    this.chatUrl =
      "https://studio.d-id.com/agents/share?id=agt_sNJybwB2&utm_source=copy&key=WVhWMGFEQjhOamRsTVdObE1qWm1Zek00T1RjMk9ESTVZakpqTmpFeU9sbzVlaTFPTjFkeVpXVXdZWEpRUmpSWlVXdzVWUT09";
    this.iframe = null;
    this.init();
  }
